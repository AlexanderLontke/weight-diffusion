...
TASK_METADATA = {
    ...
    "mnist_error": {
        "task_test_fn": lambda *args, **kwargs: data_gen.train_mnist.test_epoch(
            *args, **kwargs
        )[1],
        "constructor": lambda: data_gen.train_mnist.MLP(w_h=10),
        "data_fn": data_gen.train_mnist.unload_test_set,
    ...
    "cifar10_error": {
        "task_test_fn": lambda *args, **kwargs: data_gen.train_cifar10.test_epoch(
            *args, **kwargs
        )[1],
        "constructor": data_gen.train_cifar10.ConvNet,
        "data_fn": data_gen.train_cifar10.unload_test_set,
    ...
    "cartpole": {
        "task_test_fn": lambda *args, **kwargs: data_gen.train_rl.vis_test_policy(
            *args, maxlen=200, **kwargs
        ),
