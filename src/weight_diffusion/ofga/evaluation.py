...
def evaluate_generated_models(epochs: int, prompt: str, models: List[mnist_task.CNN], input, target):
    k = len(models)
...
def _evaluate_model(model, input, target):
    # TODO evaluate model accuracy, our code or Konstantin's? 
